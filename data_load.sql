...
put file:///<path>/exchange_rates.csv @finance.exchange_rates auto_compress=false;
put file:///<path>/geo_lookup.csv @finance.geo_lookup auto_compress=false;
put file:///<path>/0_Analytics_Accelerator/daily_subs.csv @finance.daily_subs auto_compress=false;
put file:///<path>/0_Analytics_Accelerator/daily_subs_2.csv @finance.daily_subs_2 auto_compress=false;
